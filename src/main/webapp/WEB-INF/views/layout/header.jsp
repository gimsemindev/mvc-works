	...
	<div class="navbar-right">
		...
		<button class="nav-icon-btn position-relative">
			<i class="far fa-bell"></i> <span
				class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger navbar-badge">5</span>
		</button>
			...
			<div class="dropdown">
				...
				<ul class="dropdown-menu dropdown-menu-end">
					<li><a href="${pageContext.request.contextPath}/"
						class="dropdown-item"><i class="fas fa-images me-2"></i>사진첩</a></li>
					<li><a href="${pageContext.request.contextPath}/"
						class="dropdown-item"><i class="fas fa-calendar me-2"></i>일정관리</a></li>
					<li><a href="${pageContext.request.contextPath}/"
						class="dropdown-item"><i class="fas fa-envelope me-2"></i>쪽지함</a></li>
					<li><a href="${pageContext.request.contextPath}/"
						class="dropdown-item"><i class="fas fa-mail-bulk me-2"></i>메일</a></li>
