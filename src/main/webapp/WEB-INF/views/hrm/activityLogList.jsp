...
<%--
    활동내역 Vue 템플릿
    테이블: ACTIVITY_LOG
    READ-ONLY 화면 (등록/수정/삭제 없음, 상세 모달로 before_data / after_data 확인)
--%>
        ...
        <div class="al-main">
            ...
            <div class="al-filter-card">
                <div class="al-filter-row">
                    ...
                    <div class="al-filter-group">
                        <label>사원번호</label>
                        <input type="text" v-model="store.searchParams.actorEmpId"
                    ...
                    <div class="al-filter-group">
                        <label>이름</label>
                        <input type="text" v-model="store.searchParams.actorName"
                    ...
                    <div class="al-filter-group">
                        <label>메뉴</label>
                        <input type="text" v-model="store.searchParams.targetMenu"
                               placeholder="메뉴 입력" @keyup.enter="store.search()">
                    </div>

                    <!-- 처리결과 -->
                    <div class="al-filter-group">
                        <label>처리결과</label>
                        <select v-model="store.searchParams.result" @change="store.search()">
                    ...
                    <div class="al-filter-group">
                        <label>작업유형</label>
                        <select v-model="store.searchParams.actionType" @change="store.search()">
                            <option value="">전체</option>
                    ...
                    <div class="al-filter-group">
                        <label>로그일(시작)</label>
                        <input type="date" v-model="store.searchParams.startDate"
                               @change="store.search()">
                    </div>

                    <div class="al-filter-group">
                        <label>로그일(종료)</label>
                        <input type="date" v-model="store.searchParams.endDate"
                               @change="store.search()">
                    </div>

                    <!-- 버튼 그룹 -->
                    <div class="al-filter-btns">
                        <button class="al-btn al-btn-search" @click="store.search()">
                            <i class="bi bi-search"></i> 검색
                        </button>
                        <button class="al-btn al-btn-reset" @click="store.resetSearch()">
            ...
            <div class="al-toolbar">
                ...
                <div class="al-toolbar-right">
                    <button class="al-btn al-btn-excel-down" @click="store.excelDownload()">
                    ...
                    <table class="al-table">
                        <thead>
                            <tr>
                                ...
                                <!-- 로그ID -->
                                <th class="sortable" @click="store.sortBy('logId')">
                                    로그ID
                                ...
                                <!-- 수행자 사원번호 -->
                                <th class="sortable" @click="store.sortBy('actorEmpId')">
                                    사원번호
                                ...
                                <!-- 수행자 이름 -->
                                <th class="sortable" @click="store.sortBy('actorName')">
                                    이름
                                ...
                                <!-- 작업유형 -->
                                <th class="sortable" @click="store.sortBy('actionType')">
                                    작업유형
                                ...
                                <!-- 메뉴 -->
                                <th class="sortable" @click="store.sortBy('targetMenu')">
                                    메뉴
                                ...
                                <!-- 처리결과 -->
                                <th class="sortable" @click="store.sortBy('result')">
                                    처리결과
                                ...
                                <!-- 로그일시 -->
                                <th class="sortable" @click="store.sortBy('logDate')">
                                    로그일시
...
<!-- ===== 상세 모달 ===== -->
<div class="al-modal-overlay" v-if="store.showDetail" @click.self="store.closeDetail()">
    <div class="al-modal" v-if="store.detailItem">
